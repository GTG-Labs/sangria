...
Based on Sangria's architecture, we support one payment scenario today, with two more planned:

1. **Client external, merchant on Sangria** _(supported now)_
   An external client (AI agent or raw wallet) pays USDC on-chain; Sangria credits the merchant's fiat balance.

2. **Client on Sangria, merchant external** _(planned)_
...
3. **Client and merchant both on Sangria** _(planned)_
   Settlement happens as an internal ledger transfer for speed and cost efficiency, with no on-chain hop needed.
