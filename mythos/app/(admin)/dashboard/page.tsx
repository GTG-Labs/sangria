...
export default function DashboardPage() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-fg">Admin Dashboard</h1>

      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <Link
          href="/newspaper"
          className="group rounded-2xl border border-white/8 bg-surface p-6 transition hover:border-accent/40 hover:bg-elevated"
        >
